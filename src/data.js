  ...
  members: [
    {
      ...
      name: "Shivam Shah",
      role: "Founder & CEO",
      bio: "Business owner and operator with firsthand experience navigating the challenges of stepping away from an owner-dependent business. Leads OwnerAway’s coverage strategy, operator standards, and pilot engagements with a focus on reliability and continuity.",
    },
    {
      initials: "AS",
      photo: teamAdit,
      ...
      bio: "Builds the technology behind OwnerAway’s coverage experience, from daily reporting and operational playbooks to owner communication. Focused on creating reliable, scalable tools that give owners and relief managers clarity and consistency.",
    },
    {
      initials: "AS",
      photo: teamAnkita,
      ...
      bio: "Brings hands-on operational experience and a practical understanding of how day-to-day issues impact business performance. Leads the systems, standards, and support that help relief managers step in confidently and keep businesses running smoothly.",
    },
    {
      initials: "YOU",
      name: "Your Name Here",
      role: "Join the OwnerAway Team",
      bio: "We're looking for people who believe great businesses shouldn't depend on one person. Bring your experience, leadership, and ideas to help us build a smarter, more reliable way for business owners to step away.",
    },
  ],
};
